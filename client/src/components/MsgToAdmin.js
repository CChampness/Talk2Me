...
// This message could be from a user who is logged in
// or anyone who is not logged in.
...
const MsgToAdmin = () => {
  ...
  if (Auth.loggedIn()) {
    ...
    currentUserName = "NotLoggedIn";
  }

  return (
    <Container>
      <h2>Leave your message for the site Admin</h2>
        ...
        <Form.Row>
          ...
          <Col xs={12} md={4}>
            <Button type='submit' variant='success' size='lg'>
              Save message for the site Admin
            </Button>
          </Col>
        </Form.Row>
      </Form>
